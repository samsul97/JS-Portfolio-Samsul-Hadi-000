...
class Home extends React.Component<{}> { 
  ...
  render(){
    return (
      <>
          <Head>
            <title>Samsul Hadi - Software Engineer</title>
          ...
          <div className='w-full h-[100vh] '>
            <div className='w-full md:w-[60%] h-full text-white font-medium flex justify-center items-center'>
              <div>
                <div className='text-32 md:text-45 py-8 text-center md:text-left'>Samsul Hadi</div>
                ...
                <div className='text-36 pb-8 text-center md:text-left'>
                  <Link href={'/contact'}>
