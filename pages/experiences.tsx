  ...
  render() {
    return (
      <>
        ...
        <main className='flex flex-col items-center justify-center w-screen h-screen p-4 mt-11 md:mt-8 sm:mt-10 xs:mt-10'>
          <div className="rounded-xl bg-gradient shadow-xl overflow-auto w-full max-w-2xl p-3 card">
