            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <div className='w-full h-full flex items-center justify-center md:pr-20'>
                <div className='text-white text-12 md:text-lg font-medium '>
                  ...
                  It is time to implement Technology to your business:<br/>
                  <div className='text-18 md:text-22 mb-1'>My Story</div>
                  &nbsp;&nbsp;- I have loved raising and gardening since I was 10 years old<br/>
                  &nbsp;&nbsp;- I love business since i was kid. At 15, I sell my business to make money<br/>
                  &nbsp;&nbsp;- At 21, I chose to design a life that aims for my dreams and am currently building a business in the technology sector.<br/>
                  
                  <div className='text-18 md:text-22 mb-1'>My Obsession</div>
                  &nbsp;&nbsp;- My obsession is educate people who want understand technology and implement them in their business<br/>
                  &nbsp;&nbsp;- Makes everyone feel helped by the technology that I created, especially in Indonesia<br/> */}
                  
                  <div className='h-3'></div>
                  The things I love:<br/>
                  &nbsp;&nbsp;- Learning New Skill, Improve MYSELF<br/>
                  &nbsp;&nbsp;- Build Trust and Build Long-Term Relationship<br/>
                  &nbsp;&nbsp;- Adventure, Business, Billiards, Gardening<br/>
