...
class Home extends React.Component<{}, {}> {   
  ...
  render(){
    return (
      <>
        <Head>
          <title>My Services - Samsul Hadi</title>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <div className='w-full h-full flex items-center justify-center md:pr-24'>
                <div className='text-white text-sm md:text-lg font-medium'>
                  <div className='text-28 md:text-36 pt-4 pb-6 font-semibold text-center md:text-left'>Service Support</div>
                  <div className='my-1'>- Website Development</div>
                  <div className='my-1'>- Web Apps Development</div>
                  <div className='my-1'>- Mobile Apps</div>
                  <div className='my-1'>- Server Configuration</div>
                  <div className='my-1'>- Hardware Installation</div>
                  <div className='my-1'>- Digital Marketing Branding</div>
                  <div className='my-1'>- Network Infrastructure</div>
                  <div className='my-1'>- Web Scraping and Crawling, Automation</div>
                  <div className='my-1'>- Multimedia</div>
