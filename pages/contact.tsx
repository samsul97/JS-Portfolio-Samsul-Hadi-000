...
import { FaMailBulk, FaSkype, FaLinkedin, FaGithub, FaSlack, FaTelegram, } from 'react-icons/fa';
...
const sendEmail = () => {    
  window.open("mailto:samsulaculhadi@gmail.com?subject=Contact");
};
              ...
              <div className='text-white text-base md:text-lg font-normal'>
                ...
                <div className='mt-20'>
                  ...
                  <div className='text-white text-xl md:text-45 font-medium mt-2 flex justify-between items-center'>
                    <Link href={'https://www.linkedin.com/in/samsul-hadi-643a3a169/'}>
                    ...
                    <Link href={'https://t.me/samsulhadisugali'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaTelegram/>
                      </a>
                    </Link>
