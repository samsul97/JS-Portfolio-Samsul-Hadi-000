...
import { FaLinkedin, FaGithub, FaSlack, FaWhatsapp, } from 'react-icons/fa';
...
const sendEmail = () => {    
  window.open("mailto:samsulaculhadi@gmail.com?subject=Hi, saya ingin kerjasama dengan Anda");
};
              ...
              <div className='text-white text-base md:text-lg font-normal'>
                  ...
                  <div className='text-lg md:text-36 font-medium'>
                    <Link href={'#'}>
                      <a className='hover:text-amber-500' onClick={()=>sendEmail()}>
                        <div className=''>samsulaculhadi@gmail.com</div>                
                      </a>
                    </Link>
                </div>
                </div>
                <div className='mt-20'>
                  ...
                  <div className='text-white text-xl md:text-45 font-medium mt-2 flex justify-between items-center'>
                    <Link href={'https://www.linkedin.com/in/samsulhadi-ss'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaLinkedin/>
                      </a>
                    </Link>
                    <Link href={'https://github.com/samsul97'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaGithub/>
                      </a>
                    </Link>
                    <Link href={'https://app.slack.com/client/T011B2Q3BCP/D011B2Q3BF1'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaSlack/>
                      </a>
                    </Link>
                    <Link href={'https://whatsapp.com/channel/0029VafNmFQKQuJJSVa95o2M'}>
                      <a target={'_blank'} className='hover:text-amber-500'>
                        <FaWhatsapp/>
                      </a>
                    </Link>
